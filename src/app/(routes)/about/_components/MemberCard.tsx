...
const MemberCard=({member}:{member:{name:string,position:string,photo:string}})=>{
                ...
                <div className="h-[30%] flex justify-start items-end">
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-2">
                            <div className="font-medium text-base sm:text-lg md:text-2xl lg:text-3xl">{member.name}</div>
